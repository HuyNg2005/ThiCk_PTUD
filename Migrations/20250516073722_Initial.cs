    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CheckInByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CheckOutByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Users_CheckInByUserId",
                        column: x => x.CheckInByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_Users_CheckOutByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CheckInByUserId",
                table: "Bookings",
                column: "CheckInByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CheckOutByUserId",
                table: "Bookings",
